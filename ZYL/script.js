...
function calculateDays() {
    ...
    function startTimeUpdate(timeLineElement) {
        const startDate = new Date('2025-08-26T15:49:39+08:00');
        ...
        function updateTime() {
            ...
            const timeDiff = currentDateCST - startDate;
            ...
            if (!isInitialized) {
                timeLineElement.setAttribute('data-initialized', 'true');
            }
        }
